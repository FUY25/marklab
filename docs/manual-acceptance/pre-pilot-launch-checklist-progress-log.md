...
| 3 | Server/data lifecycle audit | In progress | TBD | Deploy/version path passed at commit `7f47410cf8ba4c19a73c7bf725995722675b5560`, deployed to Fly release `v12`. Sharing & Versions, live-provider checkpoints, restore-to-provider, server-side provider autosave, Delete Cloud Copy, and autosave retention are implemented locally. Gate 3 is not fully passed until the hosted delete/version lifecycle smoke and final verification pass. |
...
- [ ] Re-run hosted delete/version lifecycle smoke after deletion and retention land.
