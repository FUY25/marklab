...
- [x] Run Phase 1 smoke.
- [ ] Run Phase 2 convergence and presence.
- [ ] Run Phase 3 permissions and lifecycle.
- [ ] Run Phase 4 edge cases.
- [ ] Run Phase 5 native polish.
- [ ] Append final acceptance summary to `bug.md`.
- [ ] Classify every finding as P0, P1, P2, or deferred.
